...
A decomposição do modelo ETS "MMM" e do modelo ETS "AAA com Dumped" e transformação de Box-Cox são ilustrados abaixo.
...
setwd("D:/materias/series/Series-Trabalho2")
...
```{r}
h=5
plot(f_arima(serie,h), main="Modelo ARIMA(1,1,1)(1,0,1)[12]")
plot(f_arima_boxcox(serie,h), main="Modelo ARIMA(1,1,1)(1,0,1)[12] com transformação")
plot(f_ets(serie,h), main="Modelo ETS(M,M,M)")
plot(f_ets_boxcox(serie,h), main="Modelo ETS(A,A,A) com transformação")
```
